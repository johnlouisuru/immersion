        ...
        const marker = L.marker([loc.latitude, loc.longitude])
          ...
          .bindPopup(`
            <div class="p-1">
              ...
              ${loc.video_path ? `<img src="../student/${loc.video_path}" class="img-thumbnail mt-2" style="cursor:pointer;max-width:120px;" onclick="showImageModal('${loc.video_path}')">` : ""}
            </div>
          `);
        markers.push(marker);
      });
